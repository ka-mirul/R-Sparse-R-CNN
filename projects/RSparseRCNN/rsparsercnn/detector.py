...
class RSparseRCNN(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self.init_proposal_bg_features = nn.Embedding(self.num_proposals, self.hidden_dim) # [100, 256]
        ...
        nn.init.constant_(self.init_proposal_boxes.weight[:, 4], 0.25) # 45/180 (-180 to 180)
        #'''
    ...
    def forward(self, batched_inputs, do_postprocess=True):
        ...
        # Prediction.
        outputs_class, outputs_coord = self.head(features, proposal_boxes, self.init_proposal_features.weight, self.init_proposal_bg_features.weight)
    ...
    def prepare_targets(self, targets):
        ...
        for targets_per_image in targets:
            ...
            image_size_xyxy = torch.as_tensor([w, h, w, h, 1], dtype=torch.float, device=self.device)
