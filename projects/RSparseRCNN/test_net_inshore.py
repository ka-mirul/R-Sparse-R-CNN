...
def main(args):
    ...
    if cfg.DATASET_NAME == 'SSDD': 
        print('#'*200)
        print('Testing SSDD Inshore dataset')
        print('#'*200)

        # MODEL_PATH = r"saved_models/model_SSDD.pth"
        # REGISTER THE IMAGES & GROUND TRUTHS
        JSON_PATH = r"eval_json/SSDD_test_inshore_COCO_OBB_Detectron.json"
        ...
        print('#'*200)
        print('Testing RSDD Inshore dataset')
        print('#'*200)
        # MODEL_PATH = r"saved_models/model_RSDD.pth"

        # REGISTER THE IMAGES & GROUND TRUTHS
        JSON_PATH = r"eval_json/RSDD_test_inshore_COCO_OBB_Detectron.json"
